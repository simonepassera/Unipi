...
max_depth = 11
soluzione_DF_ex1_limited = limited_depth_first_search_tree(teseo1,max_depth)
print("Soluzione EX.1 con limited depth_first_search_tree, actions = ['UP','RIGHT','DOWN','LEFT'], max_depth = 10")
print_solution(soluzione_DF_ex1_limited); print()
input('>')

# breadth first search
soluzione_BF_ex1 = breadth_first_search(teseo1)
print("Soluzione EX.1 con breadth_first_search e actions = ['UP','RIGHT','DOWN','LEFT']")
print_solution(soluzione_BF_ex1); print()
...
#depth first
# nota se si usa teseo1 invece che teseo2 va in loop
